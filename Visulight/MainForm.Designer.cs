namespace Visulight
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ex_Soleil_Neptune = new System.Windows.Forms.Button();
			this.ex_Jupiter_Europe = new System.Windows.Forms.Button();
			this.ex_Saturne_Titan = new System.Windows.Forms.Button();
			this.ex_Terre_Voyager1 = new System.Windows.Forms.Button();
			this.customExamples = new System.Windows.Forms.Label();
			...
			this.customLabelPointB = new System.Windows.Forms.Label();
			this.customTextBoxPointB = new System.Windows.Forms.TextBox();
			this.customLabelPointA = new System.Windows.Forms.Label();
			this.customTextBoxPointA = new System.Windows.Forms.TextBox();
			this.presetLabelScale = new System.Windows.Forms.Label();
			this.customNumeric = new System.Windows.Forms.NumericUpDown();
			this.customLabelKm = new System.Windows.Forms.Label();
			this.customRadioButton = new System.Windows.Forms.RadioButton();
			this.customLabelMinimumDistance = new System.Windows.Forms.Label();
			this.presetLabelDistance = new System.Windows.Forms.Label();
			...
			this.lbPointB = new System.Windows.Forms.Label();
			this.lbPointA = new System.Windows.Forms.Label();
			...
			((System.ComponentModel.ISupportInitialize)(this.customNumeric)).BeginInit();
			this.panelSimulation.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.pbPointA)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.pbPointB)).BeginInit();
			this.SuspendLayout();
			// 
			// panelOptions
			// 
			...
			this.panelOptions.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(32)))), ((int)(((byte)(32)))), ((int)(((byte)(32)))));
			this.panelOptions.Controls.Add(this.ex_Soleil_Neptune);
			this.panelOptions.Controls.Add(this.ex_Jupiter_Europe);
			this.panelOptions.Controls.Add(this.ex_Saturne_Titan);
			this.panelOptions.Controls.Add(this.ex_Terre_Voyager1);
			this.panelOptions.Controls.Add(this.customExamples);
			this.panelOptions.Controls.Add(this.separator2);
			this.panelOptions.Controls.Add(this.separator1);
			this.panelOptions.Controls.Add(this.separator3);
			this.panelOptions.Controls.Add(this.customLabelPointB);
			this.panelOptions.Controls.Add(this.customTextBoxPointB);
			this.panelOptions.Controls.Add(this.customLabelPointA);
			this.panelOptions.Controls.Add(this.customTextBoxPointA);
			this.panelOptions.Controls.Add(this.presetLabelScale);
			this.panelOptions.Controls.Add(this.customNumeric);
			this.panelOptions.Controls.Add(this.customLabelKm);
			this.panelOptions.Controls.Add(this.customRadioButton);
			this.panelOptions.Controls.Add(this.customLabelMinimumDistance);
			this.panelOptions.Controls.Add(this.presetLabelDistance);
			this.panelOptions.Controls.Add(this.presetComboBox);
			this.panelOptions.Controls.Add(this.presetRadioButton);
			this.panelOptions.Controls.Add(this.labelTitle);
			...
			this.ex_Soleil_Neptune.Click += new System.EventHandler(this.CustomExample_Click);
			// 
			// ex_Jupiter_Europe
			// 
			...
			this.ex_Jupiter_Europe.Click += new System.EventHandler(this.CustomExample_Click);
			// 
			// ex_Saturne_Titan
			// 
			...
			this.ex_Saturne_Titan.Click += new System.EventHandler(this.CustomExample_Click);
			// 
			// ex_Terre_Voyager1
			// 
			...
			this.ex_Terre_Voyager1.Click += new System.EventHandler(this.CustomExample_Click);
			// 
			// customExamples
			// 
			...
			// customTextBoxPointB
			// 
			this.customTextBoxPointB.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(64)))), ((int)(((byte)(64)))));
			...
			this.customTextBoxPointB.TextChanged += new System.EventHandler(this.CustomTextBox_TextChanged);
			// 
			// customLabelPointA
			// 
			...
			// customTextBoxPointA
			// 
			this.customTextBoxPointA.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(64)))), ((int)(((byte)(64)))));
			...
			this.customTextBoxPointA.TextChanged += new System.EventHandler(this.CustomTextBox_TextChanged);
			// 
			// presetLabelScale
			// 
			...
			// customNumeric
			// 
			this.customNumeric.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(64)))), ((int)(((byte)(64)))));
			this.customNumeric.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.customNumeric.Font = new System.Drawing.Font("Segoe UI", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.customNumeric.ForeColor = System.Drawing.Color.White;
			this.customNumeric.Increment = new decimal(new int[] {
            10000,
            0,
            0,
            0});
            ...
            0,
            0});
			this.customNumeric.Minimum = new decimal(new int[] {
            36000,
            0,
            0,
            0});
            ...
            0,
            0});
			this.customNumeric.ValueChanged += new System.EventHandler(this.CustomNumeric_ValueChanged);
			// 
			// customLabelKm
			// 
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.panelSimulation.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(16)))), ((int)(((byte)(16)))), ((int)(((byte)(16)))));
			this.panelSimulation.Controls.Add(this.lbPointB);
			this.panelSimulation.Controls.Add(this.lbPointA);
			...
			// lbPointB
			// 
			this.lbPointB.Anchor = System.Windows.Forms.AnchorStyles.Right;
			...
			// lbPointA
			// 
			this.lbPointA.Anchor = System.Windows.Forms.AnchorStyles.Left;
			...
			((System.ComponentModel.ISupportInitialize)(this.pbPointA)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.pbPointB)).EndInit();
        ...
        private System.Windows.Forms.Label presetLabelDistance;
        private System.Windows.Forms.Label customLabelKm;
        private System.Windows.Forms.RadioButton customRadioButton;
        private System.Windows.Forms.Label customLabelMinimumDistance;
        ...
        private System.Windows.Forms.Label customLabelPointB;
        private System.Windows.Forms.TextBox customTextBoxPointB;
        private System.Windows.Forms.Label customLabelPointA;
        private System.Windows.Forms.TextBox customTextBoxPointA;
        ...
        private System.Windows.Forms.Label lbPointB;
        private System.Windows.Forms.Label lbPointA;
        private System.Windows.Forms.Button buttonHide;
        private System.Windows.Forms.Button buttonShow;
        private System.Windows.Forms.Button ex_Soleil_Neptune;
        private System.Windows.Forms.Button ex_Jupiter_Europe;
